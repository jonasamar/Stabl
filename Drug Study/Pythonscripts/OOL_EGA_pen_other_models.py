...
run_name = "Other_models_with_LeaveOneGroupOut"

# Import Data
X_EGA_pen = pd.read_csv(f"../Onset of Labor csv/{data_name}.csv",index_col="ID")
...
scatterplot_features(
	...
	show_fig=False,
	export_file=True,
	path=f"../Results/{data_name}/{run_name}/Univariate")
