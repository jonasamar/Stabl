...
from stabl.visualization import boxplot_features, scatterplot_regression_predictions, boxplot_binary_predictions, plot_roc, plot_prc
...
stablNames = ["L-KF","L-RP"] #EN05-RP", "EN05-KF"
...
def run():
    ...
    task_type="binary",
    save_path='./Results_16G_all_data',
    )
