...
#
# Description :
#       This a third attempt at creating a STABL interface. In this version, single and multi omic pipelines were taken into account.
...
#       In this version, we want the user to be able to design his or her preprocessing pipeline and access more pipelines
#       not taken into account in previous versions.
...
from STABLapp_utils.Subframes.subframeFoldername import subframeFoldername_display
from STABLapp_utils.Subframes.subframeFiles import subframeFiles_display
from STABLapp_utils.Subframes.subframeStabl import subframeStabl_display
from STABLapp_utils.Subframes.subframePipeline import subframePipeline_display
from STABLapp_utils.Subframes.subframeSbatch import subframeSbatch_display

from STABLapp_utils.subwindows.ConfirmationWindow import show_settings_and_create_files
