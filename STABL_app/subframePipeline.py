...
# Main frame
def subframePipeline_display(root, preprocess, outersplitter, n_splits, n_repeat, cv_rd, test_size, train_size):
    ...
    FinerParamButton = customtkinter.CTkButton(master=subframePipeline, text="For even finer tuning...", command= lambda : pipeline_fine_tuning())
    FinerParamButton.pack(pady=12, padx=10)
